...
echo $this->element('Admin/sidebar');
 ...
 <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
     <h2 class="sub-header"><?= __('Add User') ?></h2>
     <?= $this->Form->create($user) ?>
            ...
            <div class="form-group">
                ...
                <?php echo $this->Form->input('password', ARRAY('label' => false, 'div' => false, 'class' => 'form-control', 'id' => '','maxlength' => '50', 'placeholder' => 'Enter Password')); ?>
            </div>

            <div class="form-group">
                <label>Email</label>
                <?php echo $this->Form->input('email', ARRAY('label' => false, 'div' => false, 'class' => 'form-control', 'id' => '','maxlength' => '50', 'placeholder' => 'Enter Email')); ?>
            </div>
            ...
            <div class="form-group">
                <label>Status</label>
                <?php echo $this->Form->checkbox('status', ARRAY('label' => false, 'div' => false, 'class' => 'checkbox','checked'=>'checked')); ?>
            </div>
